...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="./image/round3.png">
    <title>HIDDEN PARADISE</title>
</head>
...
<body>
    ...
    <section id="carouselExampleControls" class="carousel slide carousel_section" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="carousel-image" src="./image/home1.jpg" >
            </div>
            <div class="carousel-item">
                <img class="carousel-image" src="./image/home2.jpg" >
            </div>
            <div class="carousel-item">
                <img class="carousel-image" src="./image/round.png" >
            </div>
            <div class="carousel-item">
                <img class="carousel-image" src="./image/round2.png">
            </div>
        </div>
    </section>
    ...
    <section id="auth_section">
        ...
        <div class="logo">
            <img class="bluebirdlogo" src="./image/round3.png" alt="logo">
            <p>HIDDEN PARADISE</p>
        </div>
